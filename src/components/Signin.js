                ...
                <div className="left-side">
                    ...
                    <form className="login-form">
                        <div className="form-group mb-30">
                            ...
                            <input type="text" id="email" name="email" onChange={handleChange}  placeholder="Email Address" />
                        ...
                        <div className="form-group mb-0">
                            <button onClick={submit} type="submit" className="custom-button">LOG IN</button>
                        </div>
                        {
        error && <div style={{color:"red"}}>{errorMsg}</div>
                ...
                <div className="right-side cl-white">
                    <div className="section-header mb-0">
                        ...
                        <Link to ="/signup" className="custom-button transparent">Sign Up</Link>
                    </div>
                </div>
            </div>
        </div>
